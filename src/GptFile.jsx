        ...
        <AnimatePresence key={text.length}>
          ...
          {text && (
            ...
            >
              ...
              <button onClick={handleSummarize} style={{ marginTop: "1rem", backgroundColor: "darkblue" }}>
                Summarize
              </button>
              <div style={{ backgroundColor: "lightblue", borderRadius: 25, padding: 20, marginTop: 20 }}>
                <p>
                  {wordCount}/{wordLimit}
                </p>
              </div>
