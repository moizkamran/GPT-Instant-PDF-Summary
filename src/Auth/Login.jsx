...
<div style={{ display: 'grid', placeItems: 'center', height: '100vh' }}>
  <div style={{ background: 'white', boxShadow: '0 2px 4px rgba(0, 0, 0, 0.2)', padding: '20px', borderRadius: '4px' }}>
    ...
    <form onSubmit={handleSubmit} style={{display: 'flex', flexDirection:'column', justifyContent:'center', alignContent:"center", alignItems:'center'}}>
      <div style={{display:'flex', flexDirection:'column', gap:20, marginBottom: 150, marginTop: 150}}>
      ...
      <div style={{color: 'black', textAlign:'center'}}>
        ...
        <input
          ...
          style={{ width: '80%', padding: '10px', borderRadius: '4px', marginBottom: '10px' }}
        />
      </div>
      </div>
